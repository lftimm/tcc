...
Point(5) = {20*Djet,10*Djet,0,1.0};
Point(6) = {20*Djet,0,0,1.0};
Point(7) = {0,splitHeight,0,0,1.0};
Point(9) = {20*Djet,splitHeight,0,1.0};
Point(10) = {20*Djet,splitHeight,0,1.0};
Point(11) = {20*Djet,Zjet,0,1.0};
...
Physical Surface(" Pressure Outlet", 6) -= {31};
Physical Surface("Top Pressure Outlet", 8) = {31};
